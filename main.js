...
let poBtn = $(".poster_btn ul li")
let poCont = $(".poster_cont .poster")

poCont.hide().eq(0).show();
...
poBtn.click(function (e) {
    ...
    poCont.hide().eq(index).fadeIn();
    poCont.find("figure").removeClass("move")
    poCont.eq(index).find("figure").addClass("move")
